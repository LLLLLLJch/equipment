...
<body>
	<form class="form-inline" action="${pageContext.request.contextPath}/adviceIndex/findAdviceByCondition.action" method="post" id="searchForm">
	  ...
	  <div class="form-group">
	    ...
	    <input type="text" class="form-control" id="title" name="title" value="${findAdviceByCondition.title}">
	  </div>
	  <div class="form-group">
	              起止日期<input type="text" class="form-control" value="<fmt:formatDate value='${findAdviceByCondition.startTime}' pattern='yyyy-MM-dd'/>" name="startTime" id="datetimepicker1">
		 --
		  <input type="text" class="form-control" value="<fmt:formatDate value='${findAdviceByCondition.endTime}' pattern='yyyy-MM-dd'/>" name="endTime" id="datetimepicker2">
	  </div>
	    <div class="form-group">

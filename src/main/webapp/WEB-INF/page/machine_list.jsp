...
<body>
	...
	<input type="button" value="批量删除" onclick="deleteAll();" class="btn btn-default"/>
		<table class="table table-bordered">
			...
			<c:forEach items="${pageBean.list}" var="machine">
			<tr>
				<td>
					<input type="checkbox" name="selectedIds" value="${machine.id}">
				</td>
				<td><a href="javascript:showTeacher('${machine.id}');">${machine.name}</a></td>
				<td>${machine.modelNumber}</td>
				<td>${machine.workShop}号车间</td>
				<td><a href="javascript:update('${machine.id}')">修改</a></td>
				<td><a href="javascript:goDeleteTeacher('${machine.id}');">删除</a></td>
			</tr>
			</c:forEach>
		</table>
	</form>

			...
			<div class="sidebar-collapse">
				<ul class="nav" id="side-menu">
							...
							<a data-toggle="dropdown" class="dropdown-toggle" href="#"> <span
								class="clear"> <span class="block m-t-xs"
									style="font-size: 20px;"> <i class="fa fa-area-chart"></i>
										<strong class="font-bold">浩强精密机械</strong>
								</span>
							</span>
							</a>
						</div>
						<div class="logo-element">浩强</div>
					</li>
					...
					<li><a href="#"> <i class="fa fa fa-bar-chart-o"></i> <span
							class="nav-label">人员管理</span> <span class="fa arrow"></span>
					</a>
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem"
								href="${pageContext.request.contextPath}/memberIndex/findAllMember.action">人员信息</a>
							</li>
							<li><a class="J_menuItem"
								href="${pageContext.request.contextPath}/memberIndex/goAddPage.action">添加人员</a>
							</li>
						</ul></li>
					<li><a href="mailbox.html"><i class="fa fa-envelope"></i>
							<span class="nav-label">设备管理 </span></a>
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem"
								href="${pageContext.request.contextPath}/machineIndex/findAllMachine.action">设备信息</a>
							</li>
							<li><a class="J_menuItem"
								href="${pageContext.request.contextPath}/machineIndex/goAddPage.action">设备班级</a>
							</li>
						</ul></li>
					<li><a href="#"><i class="fa fa-edit"></i> <span
							class="nav-label">保养管理</span><span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem"
								href="${pageContext.request.contextPath}/maintenanceIndex/findAllMaintenance.action">保养信息</a>
							<li><a class="J_menuItem"
								href="${pageContext.request.contextPath}/maintenanceIndex/goAddPage.action">新增保养</a>
							</li>
						</ul></li>
				</ul>
			</div>
